...
class quote_init_info:
    ...
    def __repr__(self):
        return "{{target_info: {}, epid_group_id : {}}}".format(
...
def sgx_init_quote():
    ...
    c_sgx_init_quote.argtypes = [POINTER(c_sgx_target_info), POINTER(c_sgx_epid_group_id)
                                 ]
...
def sgx_get_quote_size(sig_rl=None):
    ...
    c_sgx_get_quote_size.argtypes = [c_char_p, POINTER(c_uint)
                                     ]
...
def sgx_get_quote(sgx_report, quote_type, spid, quote_nonce=None, sig_rl=None, sig_rl_size=None):
    """
    ...
    c_sgx_get_quote.argtypes = [
        POINTER(c_sgx_report), c_uint, POINTER(c_sgx_spid), POINTER(
            c_sgx_quote_nonce), c_char_p, c_uint, POINTER(c_sgx_report), POINTER(c_sgx_quote), c_uint
    ]
